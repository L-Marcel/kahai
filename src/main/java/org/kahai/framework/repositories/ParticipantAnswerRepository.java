...
public interface ParticipantAnswerRepository extends JpaRepository<ParticipantAnswer, UUID> {
    ...
    public List<ParticipantAnswer> findByNickname(String nickname);
    public void deleteByGame(Game game);
    public void deleteByQuestion(Question question);

    public List<ParticipantAnswer> findByNicknameAndGame(String nickname, Game game);
    public List<ParticipantAnswer> findByNicknameAndQuestion(String nickname, Question question);
}